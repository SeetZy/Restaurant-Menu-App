function ErrorPage() {
  document.title = '404 ERROR // RESTAURANT MENU APP'

  return (
    <div className="mt-36 h-[70vh] flex justify-center items-center">
      <div>
        <center className="mt-24 m-auto">
          ...
          <div className=" tracking-widest mt-4">
            ...
            <span className="text-gray-500 text-xl">
              Atvainojiet, Mēs nevarējām atrast to,ko tu meklēji!
            </span>
          </div>
        </center>
